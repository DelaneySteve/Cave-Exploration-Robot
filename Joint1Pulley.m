...
fprintf(['\nNo-Load Speed = Voltage Constant * Nominal Operating Voltage\nNo-Load Speed = %i',...
        ' rpm\n'],NLspeed)
%Stall Torque 
StallTorque = 31.38128;%(TorqueConst /1000) * NomOpVoltage / ArmatureResistance;
...
%Total speed recution required to reach the correct output speed 
